 ...
 */
package org.apache.commonskt.numbers.angle
...
class PlaneAngle
    ...
    fun normalize(center: PlaneAngle): PlaneAngle {
        ...
        return if (normalized < upperBound) PlaneAngle(normalized) else  // If value is too small to be representable compared to the
    ...
    companion object {
        ...
        /** Conversion factor.  */
        private val TO_RADIANS: Double = PlaneAngleRadians.TWO_PI
