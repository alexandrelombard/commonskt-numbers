 ...
 */
package com.github.alexandrelombard.commonskt.numbers.quaternion
        ...
        fun parse(s: String?): Quaternion {
            ...
            if (startBracket != 0) {
                throw QuaternionParsingException(
                    "Expected start string: $FORMAT_START"
                )
            }
            val len = s.length
            ...
            if (endBracket != len - 1) {
                throw QuaternionParsingException(
                    "Expected end string: $FORMAT_END"
                )
            }
            ...
            a = try {
                ...
                throw QuaternionParsingException(
                    "Could not parse scalar part" + elements[0]
                )
            }
            val b: Double
            b = try {
                ...
                throw QuaternionParsingException(
                    "Could not parse i part" + elements[1]
                )
            }
            val c: Double
            c = try {
                ...
                throw QuaternionParsingException(
                    "Could not parse j part" + elements[2]
                )
            }
            val d: Double
            d = try {
                ...
                throw QuaternionParsingException(
                    "Could not parse k part" + elements[3]
                )
            }
            return of(
                a,
