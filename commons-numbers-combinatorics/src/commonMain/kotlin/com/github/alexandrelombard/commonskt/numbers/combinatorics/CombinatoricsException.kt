 ...
 */
internal class CombinatoricsException
    /**
    ...
    companion object {
        ...
        fun OUT_OF_RANGE(n: Int, a: Int, b: Int) = "Number $n is out of range [$a, $b]"

        /** Error message for "out of range" condition.  */
        fun NEGATIVE(n: Int) = "Number $n is negative"

        /** Error message for "mismatch" condition.  */
        fun MISMATCH(exp: Int, act: Int) = "Expected $exp but was $act"
    }
}