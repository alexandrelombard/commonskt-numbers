...
import org.apache.commonskt.numbers.combinatorics.BinomialCoefficient.checkBinomial
import org.apache.commonskt.numbers.core.ArithmeticUtils
...
class Combinations private constructor(
    ...
    override fun iterator(): Iterator<IntArray> {
        return if (k == 0 || k == n) SingletonIterator(k) else LexicographicIterator(n, k)
    }
     ...
     */ internal constructor(
        ...
        override fun compare(
            ...
            if (a.size != k) {
                throw CombinatoricsException(CombinatoricsException.MISMATCH(a.size, k))
            }
            if (b.size != k) {
                throw CombinatoricsException(CombinatoricsException.MISMATCH(b.size, k))
            }
        ...
        private fun lexNorm(c: IntArray): Long {
            ...
            for (i in c.indices) {
                ...
                if (digit < 0 ||
                    ...
                    throw CombinatoricsException(CombinatoricsException.OUT_OF_RANGE(digit, 0, n - 1))
                }
