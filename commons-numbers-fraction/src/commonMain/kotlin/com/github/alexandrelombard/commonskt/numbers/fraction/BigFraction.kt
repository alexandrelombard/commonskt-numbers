...
class BigFraction : Number, Comparable<BigFraction>,
    ...
    fun add(value: BigInteger): BigFraction {
        ...
        return if (isZero) {
            ...
            numerator.add(denominator.multiply(value)),
            denominator
        )
    }
    ...
    fun subtract(value: BigInteger): BigFraction {
        ...
        return if (isZero) {
            ...
            numerator.subtract(denominator.multiply(value)),
            denominator
        )
    }
