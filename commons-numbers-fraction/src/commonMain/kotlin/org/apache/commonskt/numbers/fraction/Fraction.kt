...
import org.apache.commonskt.numbers.core.ArithmeticUtils.gcd
import org.apache.commonskt.numbers.core.ArithmeticUtils.pow
...
class Fraction : Number, Comparable<Fraction>, NativeOperators<Fraction> {
    ...
    override fun negate(): Fraction {
        return if (numerator == Int.MIN_VALUE) Fraction(numerator, -denominator) else Fraction(
            -numerator,
            denominator
        )
    }
    ...
    fun add(value: Int): Fraction {
        ...
        return of(toIntExact(numerator + num), denominator)
    }
    ...
    fun subtract(value: Int): Fraction {
        ...
        if (isZero) {
            ...
            return if (value == Int.MIN_VALUE) Fraction(Int.MIN_VALUE, -1) else Fraction(-value)
        }
        // Convert to numerator with same effective denominator
        val num = value.toLong() * denominator
        return of(toIntExact(numerator - num), denominator)
    ...
    companion object {
        ...
        fun from(
            ...
            return if (value == 0.0) {
                ZERO
            } else Fraction(value, epsilon, Int.MAX_VALUE, maxIterations)
        }
        ...
        fun from(
            ...
            return if (value == 0.0) {
                ZERO
            } else Fraction(value, 0.0, maxDenominator, 100)
        }
        ...
        fun parse(s: String): Fraction {
            ...
            if (slashLoc == -1) {
                return of(stripped.trim { it <= ' ' }.toInt())
            }
